...
export default function Navbar() {
  ...
  return (
    ...
    >
      <div style={{ maxWidth: '1140px', margin: '0 auto', width: '100%', padding: isMobile ? '0 16px' : '0 24px', display: 'grid', gridTemplateColumns: isMobile ? 'auto 1fr' : '1fr auto 1fr', alignItems: 'center' }}>
        {/* Logo */}
        <div style={{ display: 'flex', alignItems: 'center', gap: '8px', cursor: 'pointer', justifySelf: 'start' }} onClick={handleLogoClick}>
          <span style={{ fontSize: '26px', fontWeight: '700', color: '#f5f5f5', letterSpacing: '-0.02em' }}>PingGuard</span>
        </div>
